...
export default function Dashboard() {
  ...
  return <div className="dashboard-grid">
    ...
    <div className="stats-grid"><StatCard label="Available balance" value={balance} meta="Updated just now" icon={Wallet} /><StatCard label="Transactions" value={transactionCount} meta="This month" icon={Receipt} tone="soft" /><StatCard label="Top category" value={summary.topCategory || category[0]?.category || '—'} meta={summary.topCategoryAmount ? money(summary.topCategoryAmount) : 'Keep an eye on it'} icon={Activity} tone="soft" /></div>
